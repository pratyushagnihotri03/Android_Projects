...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("pink", "rosa", R.drawable.color_pink));
        words.add(new Word("orange", "orange", R.drawable.color_orange));
        words.add(new Word("purple", "lila", R.drawable.color_purple));
        words.add(new Word("dusty yellow", "staubiges Gelb", R.drawable.color_dusty_yellow));
